...
const pack: Pack = {
  ...
  steps: [
    ...
    },
    {
      ...
      verify: {
        ...
        custom: (r) => ({
          ...
          reason: 'expected output to mention github.com',
        }),
      },
      hints: [
    ...
    },
    {
      ...
      verify: { mode: 'shell', stdoutContains: 'create', exitCode: 0 },
      hints: [
    ...
    },
    {
      ...
      verify: { mode: 'shell', stdoutContains: 'cli/cli', exitCode: 0 },
      hints: [
